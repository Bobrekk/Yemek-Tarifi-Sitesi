<%@ Page Title="" Language="C#" MasterPageFile="~/Utilisateur.Master" AutoEventWireup="true" CodeBehind="Accueil.aspx.cs" Inherits="YemekTarifiSitesi.WebForm1" %>
            ...
            <table class="auto-style7">
                <tr>
                    <td class="auto-style10">
                        <a href="Details.aspx?Yemekid=<%#Eval("Yemekid") %>"><asp:Label ID="Label4" runat="server" CssClass="auto-style8" Text='<%# Eval("YemekAd") %>'></asp:Label></a>
                    </td>
                </tr>
                <tr>
